"""
docs/paper2/data/tail_probe2.py
==============================
...
Run:  nohup .venv/bin/python docs/paper2/data/tail_probe2.py \
        > docs/paper2/data/tail_probe2.log 2>&1 &
...
OUT = os.path.join(HERE, "tail_probe2.csv")
SEEDS = (0, 1, 2)
...
def main():
    ...
    print("\nsummary (mean ACL; d = mm+ball - mm, negative = wins):")
