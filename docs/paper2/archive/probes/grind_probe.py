"""
docs/paper2/data/grind_probe.py
===============================
s3.91 kill-the-grinder: can the tail lose minorminer's grind? Arms:
...
Run:  nohup .venv/bin/python docs/paper2/data/grind_probe.py \
        > docs/paper2/data/grind_probe.log 2>&1 &
...
OUT = os.path.join(HERE, "grind_probe.csv")
SEEDS = (0, 1, 2)
