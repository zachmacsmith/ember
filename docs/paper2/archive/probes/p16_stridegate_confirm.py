...
docs/paper2/data/p16_stridegate_confirm.py
=================================================
...
Run:  nohup .venv/bin/python docs/paper2/data/p16_stridegate_confirm.py \
        > docs/paper2/data/p16_stridegate_confirm.log 2>&1 &
"""
import csv
import os
import time
...
OUT = os.path.join(HERE, "p16_stridegate_confirm.csv")
SEEDS = (0, 1, 2)
TIMEOUT = 60
