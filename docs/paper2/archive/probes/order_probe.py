"""
docs/paper2/data/order_probe.py
===============================
v4 stage O1 (2026-08-08): the order-state migration, one flip. Under
...
Run:  nohup .venv/bin/python docs/paper2/data/order_probe.py \
        > docs/paper2/data/order_probe.log 2>&1 &
...
OUT = os.path.join(HERE, "order_probe.csv")
SEEDS = (0, 1, 2)
