"""
docs/paper2/data/consolidation2_probe_p16gate.py
=================================================
...
Run:  nohup .venv/bin/python docs/paper2/data/consolidation2_probe_p16gate.py \
        > docs/paper2/data/consolidation2_probe_p16gate.log 2>&1 &
"""
import csv
import os
import time
...
OUT = os.path.join(HERE, "consolidation2_probe_p16gate.csv")
SEEDS = (0, 1, 2)
TIMEOUT = 60
