...
heuristic with restarts thus remains hard to beat with learned placement. The
algorithmic primitives throughout are classical; the contribution is their
synthesis and empirical evaluation, inside the Ember benchmarking framework, for
minor embedding.
\end{abstract}
...
This paper makes six contributions, listed in the order they appear.
...
mode as carefully as the fix. The algorithmic primitives throughout are classical;
the contribution is their synthesis, application, and honest empirical validation
for minor embedding.
