...
earlier unequal-budget comparison that had appeared to beat PathFinder. We are explicit
...
PathFinder. The honest finding is a cautionary one with a useful twist. The obvious
...
and an early ``the VAE beats PathFinder-thorough'' reading was an artifact of an
...
PathFinder-thorough's best-of-$N$ restarts. As \S\ref{sec:learn-collapse} shows, for
...
($2.097$ vs.\ $2.086$); its edge over \texttt{pathfinder-thorough} was simply $8$
restarts versus $4$. \textbf{We therefore retract the earlier reading that a learned
model beat PathFinder-thorough}: it was an unequal-budget artifact on top of a
collapsed model.
