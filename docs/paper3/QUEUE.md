...
| 2 | e0_ceiling (§4.1 rule-2 deflator) | e0_ceiling.py @ caf62119, cells = 10 MM-feasible dev cells | hyde06 | 48 | ~17 | RUNNING | chained after fork rebuild |
| 3 | E0 extension (§4.1b) | e0_crossover.py @ dbdcb149 --resume | hyde06 | 48 | ~6 | QUEUED | (140, 0.12/0.08) both topos |
