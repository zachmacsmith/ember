...
| 12 | v1.2 T2 library re-verify (§4.16) | run_t2_hyde06.sh @ ed0f7692 | hyde06 | 60 | ~250-340 (~10 h wall) | DONE 2026-08-03 | ember PASS (all positives; honeycomb trip = probe-confirmed null tail); mm-beta-fb FAIL (5 real drops incl. planted_solution -104g + 3 ACL viols) — dies, remedy not spent | arms {p3-ember, p3-mm-beta-fb}; pairs vs archived m5full_z12 minorminer rows via m5_analyze --baseline-db |
| 13 | T1 remedies R1+R2 (§4.15 results note) | run_t1_remedies.sh @ 4366a255 | hyde06 | 48 | ~12 | DONE 2026-08-03 | R1 = T1a re-run (raw CSV clobbered by a mid-chain deploy of the tracked M3 record; sync now excludes result records; first-run summary preserved as replication anchor). R2 = 450 ramp rows re-run (stale fork .so, masked build error). stock/beta-dhat/arm/T1b/T1d rows stand |
...
| 16 | v1.3 T3a beta ladder (§4.17) | t3_beta_mf.py @ 1050acbe | hyde06 | 48 | ~4 | RUNNING 2026-08-03 | {minorminer, -fb, -mf} x 15 seeds, 675 rows; T3 bars 1-3 |
