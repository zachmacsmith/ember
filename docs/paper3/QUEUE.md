...
| 12 | v1.2 T2 library re-verify (§4.16) | run_t2_hyde06.sh @ ed0f7692 | hyde06 | 60 | ~250-340 (~5-7 h wall) | RUNNING 2026-08-03 (§4.15 verdicts green) | arms {p3-ember, p3-mm-beta-fb}; pairs vs archived m5full_z12 minorminer rows via m5_analyze --baseline-db |
