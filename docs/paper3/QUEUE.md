...
| 11 | v1.2 T1 chain (§4.15: T1a dev / T1b native / T1c beta / T1d race) | dev_suite.py --topo Z12 + t1b_native.yaml + p6_probes.py --topo Z12 --confirm-beta + t1d_race9.py @ sha stamped at launch | hyde06 | 48/40/48/8 | ~35 (~1-2 h wall) | QUEUED | launch after the P2 merge commit; glasgow smoke re-verified under §4.15 amendment 1 |
