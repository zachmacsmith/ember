"""Scratch: lns-cpsat vs reweave vs minorminer on a few cells (writeup aside).

Both lns-cpsat and reweave are MM-seeded improvers; this checks how the exact
CP-SAT repair compares to reweave's heuristic negotiated rip-up-reroute.
"""
import sys
...
import ember_qc.algorithms.reweave  # noqa
...
algos = ["minorminer", "reweave", "lns-cpsat"]
