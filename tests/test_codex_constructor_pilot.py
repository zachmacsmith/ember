...
@pytest.mark.parametrize('method',('native-reduced-core','demand-tree','frontier-tree','frontier-tree-bounded','frontier-tree-reinsert','propagating-tree','propagating-tree-reuse','propagating-tree-growth','multilevel-regions','multilevel-regions-v2','quotient-reconfiguration','quotient-compact','quotient-vacancy','quotient-distinct'))
