"""
ember_qc/algorithms/pf_spur.py
==============================
PathFinder variant **pathfinder-spur** — a cheap spur-pruning post-pass.
...
This variant reproduces that gain for free. After PathFinder produces a *valid*
...
class SpurRouter(PathFinderRouter):
    """PathFinder router that spur-prunes its final valid embedding."""
...
# PathFinder router in pathfinder_opt.py (no standalone algorithm here). The
