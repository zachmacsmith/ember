"""
ember_qc/algorithms/rw_dirtyset.py
==================================
Reweave variant **reweave-dirtyset** — dirty-set incremental LNS reroute
(experiment S4).

Motivation
----------
The baseline LNS improver :meth:`ReweaveRouter._lns_improve` is *round-based*:
...
class DirtySetRouter(ReweaveRouter):
    """ReweaveRouter whose LNS phase is driven by an incremental worklist."""
...
# optimized Reweave router in reweave_opt.py (no standalone algorithm here).
