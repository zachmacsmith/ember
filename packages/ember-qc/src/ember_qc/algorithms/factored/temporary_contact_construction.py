"""B023: one construction trajectory with temporary contact loss and overlap.
...
See notes/codex/tracks/b_023_policy.md for the fixed pre-code policy.
"""
...
def contact_embed(source, target, *, timeout=20.0, deadline=None, seed=0):
    ...
    info = dict(algorithm='temporary-contact-construction', version='B023', seed=seed,
