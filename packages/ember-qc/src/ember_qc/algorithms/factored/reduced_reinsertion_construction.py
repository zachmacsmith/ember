"""Degree-three core expansion with blocked-only critical-port reinsertion.
...
def reduced_core_embed(source_graph, target_graph, *, seed=0, timeout=60.0, deadline=None):
    ...
    info = dict(algorithm='degree_three_core_expansion_reinsertion', version=2, seed=seed,
