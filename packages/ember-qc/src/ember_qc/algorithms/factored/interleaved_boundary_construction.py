"""A064: one unchanged A061 construction, then interleaved original-contact reconstruction."""
import math
import time
...
from ember_qc.algorithms.factored.interleaved_boundary_reconstruction import (
    interleaved_boundary_reconstruction as _operator,
)
...
def interleaved_boundary_embed(source, target, *, seed=0, timeout=60., deadline=None):
    ...
    info = dict(algorithm='a061_interleaved_boundary', version='A064', base_calls=0,
