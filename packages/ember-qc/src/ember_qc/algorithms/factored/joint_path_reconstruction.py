"""Bounded constructive reassignment on one ordered physical path at a time.
...
def joint_path_reconstruction(embedding, source_adj, target_adj, *, validator,
    ...
    current = embedding
    current_q = None
    info = dict(status='complete', input_validated=False, accepted=0, certified=0,
