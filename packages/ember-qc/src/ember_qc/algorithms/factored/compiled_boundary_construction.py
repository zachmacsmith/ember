"""A065: one unchanged A061 construction, then exactly accelerated A064 reconstruction."""
import math
import time

from ember_qc.algorithms.factored.branched_path_construction import branched_path_embed as _base
from ember_qc.algorithms.factored.compiled_boundary_reconstruction import (
    compiled_boundary_reconstruction as _operator,
)
...
def compiled_boundary_embed(source, target, *, seed=0, timeout=60., deadline=None):
    ...
    info = dict(algorithm='a061_compiled_boundary', version='A065', base_calls=0,
