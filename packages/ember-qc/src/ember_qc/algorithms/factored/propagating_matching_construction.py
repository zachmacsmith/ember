...
Standalone standard-library constructor, specified in b_matching_feasibility.md.
...
def frontier_embed(source_graph, target_graph, *, timeout=60.0, deadline=None, seed=0):
    ...
    info = dict(algorithm='matching_feasible_domain_trees', version=9, seed=seed,
                ...
                work_unit_definition='adjacency/domain edge, domain union, queue or matching update, or value support test',
