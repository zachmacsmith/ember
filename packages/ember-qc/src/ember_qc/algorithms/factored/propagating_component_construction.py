...
Standalone standard-library constructor, specified in b_component_skip.md.
...
def frontier_embed(source_graph, target_graph, *, timeout=60.0, deadline=None, seed=0):
    ...
    info = dict(algorithm='component_screened_reconstruction_trees', version=15, seed=seed,
