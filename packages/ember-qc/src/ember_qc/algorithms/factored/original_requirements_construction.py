"""Original-only physical requirements with a filled elimination order.

One immutable original requirement graph, one at-most-once induced-core
native call, and one partial minor. Fill determines elimination order only. There is no alternate constructor on failed lifting. Native
...
def reduced_core_embed(source_graph, target_graph, *, seed=0, timeout=60.0, deadline=None):
    ...
    info = dict(algorithm='degree_three_original_requirements', version=1, seed=seed,
