"""B027: B026 with exact complete-quality-sweep recurrence termination.

Stdlib only.  See notes/codex/tracks/b_027_recurrence_policy.md. Counters measure work;
...
def contact_embed(source, target, *, timeout=60.0, deadline=None, seed=0):
    ...
    began = perf_counter()
    info = dict(algorithm='recurrence-mobile-tree-construction', version='B027', seed=seed,
