...
Standalone standard-library constructor, specified in b_port_aware_routing.md.
...
def frontier_embed(source_graph, target_graph, *, timeout=60.0, deadline=None, seed=0):
    ...
    info = dict(algorithm='port_aware_matching_domain_trees', version=11, seed=seed,
                ...
                work_unit_definition='adjacency/domain edge, domain union, queue or matching update, port-owner/obligation check, or value support test',
