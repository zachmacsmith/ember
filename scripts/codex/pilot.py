...
CONSTRUCTORS = {
    ...
    'native-site-transfer': ('packages/ember-qc/src/ember_qc/algorithms/factored/site_transfer_construction.py',
                             'reduced_core_embed'),
    'native-degree-two': ('packages/ember-qc/src/ember_qc/algorithms/factored/degree_two_construction.py',
                          'reduced_core_embed'),
    'native-supported-degree-three': ('packages/ember-qc/src/ember_qc/algorithms/factored/supported_degree_three_construction.py',
                                      'reduced_core_embed'),
    ...
    'movable-contact-single': ('packages/ember-qc/src/ember_qc/algorithms/factored/movable_contact_single_construction.py',
                               'contact_embed'),
    'whole-incidence-tree': ('packages/ember-qc/src/ember_qc/algorithms/factored/whole_incidence_construction.py',
                             'contact_embed'),
    'temporary-contact-tree': ('packages/ember-qc/src/ember_qc/algorithms/factored/temporary_contact_construction.py',
                               'contact_embed'),
    'joint-placement-tree': ('packages/ember-qc/src/ember_qc/algorithms/factored/joint_placement_construction.py',
                             'contact_embed'),
    'nonincreasing-contact-tree': ('packages/ember-qc/src/ember_qc/algorithms/factored/nonincreasing_contact_construction.py',
                                   'contact_embed'),
    ...
    'atomic-regions': ('packages/ember-qc/src/ember_qc/algorithms/atomic_regions.py',
                       'atomic_embed'),
    'compound-regions': ('packages/ember-qc/src/ember_qc/algorithms/compound_regions.py',
                         'compound_embed'),
    'connected-domains': ('packages/ember-qc/src/ember_qc/algorithms/connected_domains.py',
                          'domain_embed'),
    'adaptive-clones': ('packages/ember-qc/src/ember_qc/algorithms/adaptive_clones.py',
                        'clone_embed'),
    'wall-adaptive-clones': ('packages/ember-qc/src/ember_qc/algorithms/wall_adaptive_clones.py',
                             'clone_embed'),
    'native-branched-path': ('packages/ember-qc/src/ember_qc/algorithms/factored/branched_path_construction.py',
                             'branched_path_embed'),
    'native-ready-branched-path': ('packages/ember-qc/src/ember_qc/algorithms/factored/ready_branched_path_construction.py',
                                   'branched_path_embed'),
